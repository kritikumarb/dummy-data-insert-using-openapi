...
public class CadreDTO implements Serializable {
    ...
    public Integer getFamilyVoterId() {
        return familyVoterId;
    }

    public void setFamilyVoterId(Integer familyVoterId) {
    ...
    public String getCadreTeluguName() {
        return cadreTeluguName;
    }

    public void setCadreTeluguName(String cadreTeluguName) {
        this.cadreTeluguName = cadreTeluguName;
    }
